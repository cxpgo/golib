...
import (
	...
	"errors"
	"fmt"
	"github.com/cxpgo/golib/gf/internal/empty"
	"github.com/cxpgo/golib/gf/internal/json"
	"github.com/cxpgo/golib/gf/internal/utils"
	...
	"github.com/cxpgo/golib/gf/internal/structs"
		...
		if value == nil || empty.IsNil(rv) {
			...
			if gstr.Pos(quotedKey, "?") == -1 {
				...
				if len(quotedKey) > len(like) && gstr.Equal(quotedKey[len(quotedKey)-len(like):], like) {
					...
					// Issue: https://github.com/cxpgo/golib/gf/issues/765
